...
var tests = []tester{
	...
	{Ldate | Ltime | Lmicroseconds | Lshortfile, "XXX", "XXX" + Rdate + " " + Rtime + Rmicroseconds + " " + Rshortfile + " "},
        // flag output first:
	{Lbefore | Ldate | Ltime | Lmicroseconds | Llongfile, "XXX", Rdate + " " + Rtime + Rmicroseconds + " " + Rlongfile + " " + "XXX"},
	{Lbefore | Ldate | Ltime | Lmicroseconds | Lshortfile, "XXX", Rdate + " " + Rtime + Rmicroseconds + " " + Rshortfile + " " + "XXX"},
}
